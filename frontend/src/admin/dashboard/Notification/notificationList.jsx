...
import {   deleteContactForm, getallContactForms, moveToSpamFolder } from "../../../controllers/adminController";
    ...
    <ThemeProvider theme={theme}>
      <Accordion >
        ...
        >
          ...
          <Typography className="toggle-left" noWrap={false} variant="h6">{contactForm.name} </Typography>
          <Typography className="toggle-center" variant="h6">{dateFromObjectId(contactForm._id).toString()} </Typography>
          <Typography className="toggle-right" variant="h6" >
           
          <Button onClick={(e)=>{deleteContactStatus(e)}}><DeleteIcon /></Button>
          </Typography>
          
          {
            delContactStatus&& <DeleteNotificationAlert
            ...
            {/* {contactDetails && (
              ...
              >
                <div className="flex-data">
                  <div>Name:{contactDetails.name}</div>
                  ...
                  <div>
                  <Avatar alt="avatar" sx={{ width: "25vmin", height:"25vmin",m:"5px" }} src={contactDetails.avatar.image_url} />
                  </div>
                </div>
              </Box>
            )} */}
