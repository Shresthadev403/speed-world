...
import {
  changeOrderStatusDeliveredAndDeleted,
  deleteHistoryDeivered,
  getUserDetails,
  moveToSpamFolder,
...
function HistoryList(props) {
  ...
  const historyDeleted = () => {
    ...
    moveToSpamFolder(order._id).then((data) => {
      // console.log(data);
      if (data.sucess) {
        enqueueSnackbar("history deleted sucessfully", {
          variant: "success",
      ...
      <Accordion>
        ...
        <AccordionDetails theme={theme}>
          ...
          >
              ...
              >
                {productDetails? <div className="flex-data flex-container">
                  ...
                  </div>:"This product has been deleted"
                }
              </Box>
